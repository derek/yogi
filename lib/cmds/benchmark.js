...
var util = require('../util'),
    ...
    mods = {
        init: function(options) {
            ...
            if (options.parsed.outdir) {
                this.outdir = options.parsed.outdir;
            }
            ...
            if (options.parsed.v311) {
                this.refs.push('v3.11.0');
            }
        ...
        _executeTest: function (testpath, next) {
            ...
            if (this.outdir) {
                argsObj.out = path.resolve(process.cwd(), this.outdir, path.basename(testpath).replace(/.js$/, '.json'));
            }
            ...
            log.info('Executing: ' + argsObj.source);
