...
var util = require('../util'),
    ...
    mods = {
        ...
        _executeTest: function (testpath, next) {
            ...
            // A hack for CI until yui-benchmark is a package
            var cmd = (!this.ci) ? 'yui-benchmark' : path.resolve(__dirname + '/../../node_modules/.bin/yui-benchmark');
            child = spawn(cmd, argsArr, {
                cwd: componentRoot
            });
